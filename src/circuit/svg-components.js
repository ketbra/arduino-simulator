...
export function renderArduinoBoard(x, y) {
  ...
  powerPins.forEach((p) => {
    ...
    pinG.appendChild(svgEl('rect', { x: p.x, y: 152, width: 28, height: 16, rx: 2, fill: p.fill, stroke: '#666' }));
...
export function renderLedComponent(x, y, id) {
  ...
  g.appendChild(svgEl('circle', { cx: -6, cy: 16, r: 3, fill: '#888', class: 'pin-marker', 'data-pin': `component:${id}:anode` }));
  g.appendChild(svgEl('circle', { cx: 6, cy: 16, r: 3, fill: '#888', class: 'pin-marker', 'data-pin': `component:${id}:cathode` }));
...
export function renderRgbLedComponent(x, y, id) {
  ...
  pinNames.forEach((name, i) => {
    const px = (i - 1.5) * 10;
    g.appendChild(svgEl('circle', { cx: px, cy: 18, r: 3, fill: '#888', class: 'pin-marker', 'data-pin': `component:${id}:${name}` }));
...
export function renderResistorComponent(x, y, id) {
  ...
  g.appendChild(svgEl('circle', { cx: -22, cy: 0, r: 3, fill: '#888', class: 'pin-marker', 'data-pin': `component:${id}:pin1` }));
  g.appendChild(svgEl('circle', { cx: 22, cy: 0, r: 3, fill: '#888', class: 'pin-marker', 'data-pin': `component:${id}:pin2` }));
  return g;
}
...
export function renderPushButtonComponent(x, y, id) {
  ...
  g.appendChild(svgEl('circle', { cx: 0, cy: 0, r: 7, fill: '#888', stroke: '#666', class: 'button-cap' }));
  g.appendChild(svgEl('circle', { cx: -14, cy: -14, r: 3, fill: '#888', class: 'pin-marker', 'data-pin': `component:${id}:pin1a` }));
  g.appendChild(svgEl('circle', { cx: 14, cy: -14, r: 3, fill: '#888', class: 'pin-marker', 'data-pin': `component:${id}:pin1b` }));
  g.appendChild(svgEl('circle', { cx: -14, cy: 14, r: 3, fill: '#888', class: 'pin-marker', 'data-pin': `component:${id}:pin2a` }));
  g.appendChild(svgEl('circle', { cx: 14, cy: 14, r: 3, fill: '#888', class: 'pin-marker', 'data-pin': `component:${id}:pin2b` }));
  return g;
}
...
export function renderUltrasonicComponent(x, y, id) {
  ...
  pinNames.forEach((name, i) => {
    const px = (i - 1.5) * 14;
    g.appendChild(svgEl('circle', { cx: px, cy: 20, r: 3, fill: '#888', class: 'pin-marker', 'data-pin': `component:${id}:${name}` }));
